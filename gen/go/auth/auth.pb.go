...
type RegisterRequest struct {
	...
	Password string `protobuf:"bytes,1,opt,name=password,proto3" json:"password,omitempty"` // Password of the user to register.
}
...
type LoginRequest struct {
	...
	Password string `protobuf:"bytes,1,opt,name=password,proto3" json:"password,omitempty"`        // Password of the user.
	AppId    string `protobuf:"bytes,2,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` // ID of the app to login.
}
...
var file_auth_auth_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x04, 0x61, 0x75, 0x74, 0x68, 0x22, 0x2d, 0x0a, 0x0f, 0x52, 0x65, 0x67, 0x69, 0x73,
	...
	0x72, 0x49, 0x64, 0x22, 0x41, 0x0a, 0x0c, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x42, 0x18, 0x5a, 0x16, 0x72, 0x61, 0x31, 0x6e, 0x7a, 0x30, 0x72, 0x2e,
